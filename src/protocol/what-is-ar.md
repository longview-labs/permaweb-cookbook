...
To get a general idea of how much uploads on Arweave cost (in $AR), you can use [Arweave Fees](https://ar-fees.arweave.net/).
...
When using Arweave's [HTTP API](https://docs.arweave.org/developers/arweave-node-server/http-api), all amounts are returned in Winston.
