...
The first section of the cookbook is focused on the [Arweave Protocol](../protocol/index.md). This section explains the base layer which developers will build applications on top of, and aims to answer the whats and the whys of Arweave.
